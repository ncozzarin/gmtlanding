    ...
    return (
      <><div className="bg-neutral-100 lg:pt-8 pt-4 sm:pb-20 pb-8 sm:pr-20 pr-4 lg:pl-20 pl-4 rounded-r-xl rounded-tr-xl w-full shadow-lg text-left  rounded-b-xl">
          ...
          <div class="sm:flex  sm:items-end justify-center sm:flex-row hidden ">
            ...
            <button onClick={swapFC} aria-labelledby="changer monnai" className="lg:inline-flex hover:drop-shadow-xl hidden display items-center self-center justify-center w-10 h-10 mx-2 text-pink-100 transition-colors duration-150 bg-blue-600 rounded-full focus:shadow-outline hover:bg-blue-800">

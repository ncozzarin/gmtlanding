  ...
  const swapFC = () => {
    ...
    return (
      <><div className="bg-neutral-100 pt-8 pb-20 pr-20 pl-20 rounded-r-xl rounded-tr-xl w-full shadow-lg  text-left	 rounded-b-xl">
          ...
          <h2 class="font-bold text-left pb-12 md:text-l text-xl text-blue-700 pt-4">Convertir {currencyOption1.name} a {currencyOption2.name}</h2>
          <div class="flex sm:items-end justify-center sm:flex-row flex-col ">
            ...
            <button onClick={swapFC} aria-labelledby="changer monnai" className="inline-flex hover:drop-shadow-xl items-center self-center justify-center w-10 h-10 mx-2 text-pink-100 transition-colors duration-150 bg-blue-600 rounded-full focus:shadow-outline hover:bg-blue-800">

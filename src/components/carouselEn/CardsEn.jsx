      ...
      <div className="w-full h-1/2 relative select-none" ref={slideRef}>
        <div className=" mx-auto object-fill ">
          <div className="relative r ">
            ...
            <div className="absolute lg:bottom-[40%] bottom-[30%] left-[13%] ">
            <h2 className="text-white md:text-xl lg:text-6xl text-sm font-bold  ">{featuredImages[currentIndex].Title}</h2>
            <h3 className="text-white md:text-xl lg:text-6xl text-sm ">{featuredImages[currentIndex].Subtitle}</h3>
            </div>
          </div>
          ...
          <button onClick={handleOnPrevClick} aria-label="next image" className=" text-white p-1 rounded-full opacity-25 bg-opacity-50 cursor-pointer hover:opacity-100 transition">

...
export default function CurrencyConverterEn() {
  ...
  return (
    <div className=" w-full rounded-b-xl">
        ...
        <h3 className="lg:px-12 px-2 lg:pt-12 pt-4 m-auto font-light text-center lg:text-2xl text-base items-center leading-snug text-neutral-500 ">GMT Change, leader in the foreign exchange market at

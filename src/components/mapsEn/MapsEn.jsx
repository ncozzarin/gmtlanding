...
export default function Maps() {
  return (
    <div className="bg-neutral-100 lg:p-12 p-4 rounded-r-xl rounded-tr-xl drop-shadow-xl w-full rounded-b-xl">
        <h2 className="font-bold text-center lg:pt-12 pt-4 md:text-4xl text-xl text-blue-700 pt-1 ">OUR LOCATIONS</h2>
        ...
        <div className="lg:flex lg:flex-row flex-col justify-center lg:space-x-40 pt-8">
          <div>
            ...
            <h2 className="font-bold text-center lg:pt-12 pt-4 md:text-l text-xl text-blue-700 ">RUE ROUSSEAU 30</h2>
          </div>
          <div>
            ...
            <h2 className="font-bold text-center lg:pt-12 pt-4 md:text-l text-xl text-blue-700" alt="map to rive" aria-label="Map to rive agency">COURS DE RIVE 4</h2>
          </div>
        </div>
    </div>
  );

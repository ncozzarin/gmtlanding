...
export default function Maps() {
  return (
    <div className="bg-neutral-100 p-12 rounded-r-xl rounded-tr-xl drop-shadow-xl w-full rounded-b-xl">
        <h2 className="font-bold text-center pt-12 md:text-4xl text-xl text-blue-700 ">OUR LOCATIONS</h2>
        ...
        <div className="flex  justify-center space-x-40 pt-8">
            ...
            <a className="hover:drop-shadow-xl" aria-label="Map to rousseau agency" href="https://goo.gl/maps/dRh1ze8od6NdbY637">
                <img src={rousseauMap} alt="map to rousseap" className="rounded-r-xl rounded-tr-xl w-full w-96 h-80 rounded-b-xl object-cover" />
            </a>
            <h2 className="font-bold text-center pt-12 md:text-l text-xl text-blue-700 ">RUE ROUSSEAU 30</h2>
            </div>
            <div>
        <a className="hover:drop-shadow-xl" href="https://goo.gl/maps/47Z45ywsp5zysSoe6" >
            <img src={riveMap} alt="map to rive" className="rounded-r-xl rounded-tr-xl w-full w-96 h-80 rounded-b-xl object-cover"/>
        </a>

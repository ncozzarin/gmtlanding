    ...
    <div className="bg-neutral-100 p-12 rounded-r-xl rounded-tr-xl drop-shadow-xl w-full rounded-b-xl">
        ...
        <div className="flex  justify-center space-x-40 pt-8">
            ...
            <a className="hover:drop-shadow-xl " aria-label="Map to rousseau agency" href="https://goo.gl/maps/dRh1ze8od6NdbY637">
                <img src={rousseauMap} alt="map rousseau" className="rounded-r-xl w-full h-80 rounded-tr-xl w-96  object-cover rounded-b-xl" />
            </a>
            ...
            <a className="hover:drop-shadow-xl" href="https://goo.gl/maps/47Z45ywsp5zysSoe6" aria-label="Map to rive agency" >
              <img src={riveMap} alt="map rive" className="rounded-r-xl rounded-tr-xl w-full w-96 h-80 rounded-b-xl object-cover" />
            </a>
            <h2 className="font-bold text-center pt-12 md:text-l text-xl text-blue-700 ">COURS DE RIVE 4</h2>
            </div>
        </div>
    </div>
  );
